...
namespace WEBMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bruno", "suporte@gmail.com", new DateTime(1996, 1, 3), 3500.0, d1);
            Seller s2 = new Seller(2, "Cauan", "ti@gmail.com", new DateTime(1996, 1, 30), 3200.0, d1);
            Seller s3 = new Seller(3, "Mariana", "mariana@gmail.com", new DateTime(1996, 10, 3), 3500.0, d2);
            Seller s4 = new Seller(4, "Junior", "junior@gmail.com", new DateTime(1996, 11, 23), 3500.0, d3);
            Seller s5 = new Seller(5, "Gabriel", "gabriel@gmail.com", new DateTime(1996, 1, 31), 2500.0, d4);
            Seller s6 = new Seller(6, "Alessandro", "alessandro@gmail.com", new DateTime(1996, 11, 13), 3500.0, d3);
